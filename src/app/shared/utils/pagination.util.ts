import { PaginationModel } from '@core/models/base-pagination-response.model';
import {
...
export const generatePagination = (
  ...
  // si la página es mayor o igual a 4 mostrar el boton de inicio
  showStart = paginationData.page >= 4;
  ...
  if (paginationData.page >= 2) {
    ...
    if (
      paginationData.page === paginationData.totalPages - 1 &&
